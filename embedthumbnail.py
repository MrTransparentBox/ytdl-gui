...
class EmbedThumbnailPP(FFmpegPostProcessor):
    ...
    def __init__(self, downloader=None, already_have_thumbnail=False, atomic_path=None):
        FFmpegPostProcessor.__init__(self, downloader)
        self._already_have_thumbnail = already_have_thumbnail
        self._atomic_path = atomic_path
        ...
        if info['ext'] == 'mp3':
            ...
            if not success:
                ...
                if self._atomic_path is None:
                    ...
                    atomicparsley = self._atomic_path if check_executable(self._atomic_path, ['-v']) else None
